...
\begin{tabular}{ccccc}
\toprule
\textbf{Dimension ($D$)} & \textbf{Forward L2-UVP (\%)} & \textbf{Forward Cosine Sim} & \textbf{Inverse L2-UVP (\%)} & \textbf{Inverse Cosine Sim} \\
\midrule
2  & \textbf{5.9010\%}  & \textbf{0.8929} & \textbf{6.2682\%}  & \textbf{0.8872} \\
8  & 22.0953\%          & 0.8017          & 14.4808\%          & 0.8798          \\
16 & 38.8472\%          & 0.7679          & 23.1517\%          & 0.8693          \\
32 & 52.8947\%          & 0.7461          & 49.7188\%          & 0.7707          \\
\bottomrule
\end{tabular}
\end{table}
